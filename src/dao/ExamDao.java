...
public class ExamDao extends dao {
     ...
     *
     * @param student 生徒情報を含むStudentオブジェクト
     * @param subject 科目情報を含むSubjectオブジェクト
     * @param school 学校情報を含むSchoolオブジェクト
     * @param no テストの回数
     ...
     * @param num テストの回数 (UML図の'num'を'no'として解釈)
